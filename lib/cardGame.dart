...
class CardGameTemplate extends StatefulWidget {
  final String dbName;
  final String title;
  final String responseDB;

  const CardGameTemplate({Key key, this.dbName, this.title, this.responseDB})
      : super(key: key);

  @override
  _CardGameTemplateState createState() => _CardGameTemplateState();
}

class _CardGameTemplateState extends State<CardGameTemplate>
                                ...
                                style: TextStyle(
                                  fontSize:
                                      SizerUtil.deviceType == DeviceType.mobile
                                          ...
                                          : 10.sp,
                                  fontFamily: "Muli",
                                  color: data['answered'].contains(userId) &&
                                          currentFilter == "unanswered"
                                      ? Color(0xFF025373)
                                      : currentFilter == "all"
                                          ? Color(0xFF025373)
                                  ...
                                  return Center(
                                    child: Column(
                                      children: [
                                        ...
                                        Text(
                                          "You have not played this card yet!, double tap this card",
                                          textAlign: TextAlign.center,
                                          style: TextStyle(
                                            fontSize: 10.sp,
                                            fontFamily: "Muli",
